    ...
    public class AccountController : Controller
    {
        ...
        public void GuiMail(string nguoinhan, string tieude, string noidung)
        {
            ...
            try
            {
                ...
                smtp.Credentials = new NetworkCredential("phuongha116a3@gmail.com", "htnp0862247128");

                //Tham số lần lượt là địa chỉ người gửi, người nhận, tiêu đề và nội dung thư
                smtp.Send("Quản Lý Thu Chi<phuongha116a3@gmail.com>", nguoinhan, tieude, noidung);
